...
class LocalWebController(tornado.web.Application):
    ...
    def __init__(self, port=8887, mode='user',address='0.0.0.0'):
        """
    ...
    def update(self):
        ...
        self.listen(self.port, address=self.address)
...
class WebFpv(Application):
    ...
    """
	#here was def __init__(self, port=8890):
    def __init__(self, port=8890, address='0.0.0.0'):
        self.port = port
        this_dir = os.path.dirname(os.path.realpath(__file__))
        self.static_file_path = os.path.join(this_dir, 'templates', 'static')
    ...
    def update(self):
        ...
        #here was self.listen(self.port) 
